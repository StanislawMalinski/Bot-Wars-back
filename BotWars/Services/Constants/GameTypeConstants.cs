...
{
    public class GameTypeConstants
    {
        public const string GAMETYPE_CREATED_SUCCESS = "A game type has been successfully created";
        public const string GAMETYPE_CREATED_FAILURE = "A game type could not have been created";
