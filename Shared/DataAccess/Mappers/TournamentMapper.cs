...
public class TournamentMapper : ITournamentMapper
{
    ...
    public TournamentDto TournamentToDTO(Tournament tournament)
    {
        ...
        if (tournament.Image != null) dto.Image = Convert.ToBase64String(tournament.Image);
    ...
    public TournamentResponse TournamentToTournamentResponse(Tournament tournament)
    {
        ...
        if (tournament.TournamentReference?.FirstOrDefault() != null &&
            tournament.TournamentReference.First().Bot != null &&
            tournament.TournamentReference.First().Bot.Player != null)
        ...
        if (tournament.Image != null) tournamentResponse.Image = Convert.ToBase64String(tournament.Image);
        if (tournament.Creator != null) tournamentResponse.CreatorName = tournament.Creator.Login;
    ...
    public Tournament TournamentRequestToTournament(TournamentRequest tournamentRequest)
    {
        ...
        if (tournamentRequest.Image != null) tournament.Image = Convert.FromBase64String(tournamentRequest.Image);
