...
public class PlayerController : Controller
{
    ...
    public async Task<IActionResult> SearchByName([FromQuery] string playerName,
    ...
    {
        var userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
        return (await _playerService.DeletePlayerAsync(long.Parse(userId), passwordRequest))
