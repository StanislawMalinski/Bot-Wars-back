...
public class TournamentController : Controller
{
    ...
    public async Task<IActionResult> GetListOfTournamentsFiltered(
        [FromBody] TournamentFilterRequest tournamentFilterRequest, [FromQuery] PageParameters pageParameters)
    {
        return (await _tournamentService.GetListOfTournamentsFiltered(tournamentFilterRequest, pageParameters)).Match(
            Ok, this.ErrorResult);
    }
