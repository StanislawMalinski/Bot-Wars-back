...
public class UserSettingsService : IUserSettingsService
{
    ...
    public UserSettingsService(IUserSettingsRepository userSettingsRepository, IPlayerRepository playerRepository,
    ...
    public async Task<HandlerResult<Success, IErrorResult>> CreateUserSettingsForPlayer(long playerId)
    {
        ...
        if (await _userSettingsRepository.GetUserSetting(playerId) != null) return new AccessDeniedError();
