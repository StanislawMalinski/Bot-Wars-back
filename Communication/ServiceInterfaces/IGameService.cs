...
public interface IGameService
{
    ...
    Task<HandlerResult<SuccessData<IFormFile>, IErrorResult>> GetGameFile(long id);
    ...
    Task<HandlerResult<SuccessData<PageResponse<GameResponse>>, IErrorResult>> GetGamesByPlayer(string? name,
        PageParameters pageParameters);

    Task<HandlerResult<SuccessData<PageResponse<GameResponse>>, IErrorResult>> GetListOfTypesOfAvailableGames(
        PageParameters pageParameters);

    Task<HandlerResult<SuccessData<PageResponse<GameResponse>>, IErrorResult>> Search(string? name,
        PageParameters pageParameters);
}