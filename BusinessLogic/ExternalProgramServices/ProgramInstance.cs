using BusinessLogic.ExternalProgramServices.Constrain.ConcreteConstrain;
...
namespace BusinessLogic.ExternalProgramServices
{
	public class ProgramInstance
	{
		...
		public ProgramInstance(IFileData fileData, IGameManager gameManager)
		{
		...
		public ProgramInstance(string path, IGameManager gameManager)
		{
			_path = path;
			_gameManager = gameManager;
		}
